...
export class AuthService {
  ...
  constructor(
    ...
    private readonly googleOptions: GoogleStrategyOptions,
    private readonly httpService: HttpService // private readonly usersService: UsersService, // private readonly groupsService: GroupsService
  ) {
